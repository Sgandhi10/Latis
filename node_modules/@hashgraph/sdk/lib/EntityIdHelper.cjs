...
function constructor(props, realmOrNull, numOrNull) {
  ...
  /** @type {Long | number} */
  props)] : [props.shard != null ? _long.default.fromValue(props.shard) : _long.default.ZERO, props.realm != null ? _long.default.fromValue(props.realm) : _long.default.ZERO, _long.default.fromValue(props.num)]; // Make sure none of the numbers are negative
