...
const HARDEDED = 0x80000000; /// m/44'/3030'/0'/0' - All paths in EdDSA derivation are implicitly hardened.

exports.HARDEDED = HARDEDED;
const HEDERA_PATH = [44, 3030, 0, 0]; /// m/44'/3030'/0'/0

exports.HEDERA_PATH = HEDERA_PATH;
const SLIP44_ECDSA_HEDERA_PATH = [44 | HARDEDED, 3030 | HARDEDED, 0 | HARDEDED, 0]; /// m/44'/60'/0'/0
